...
void agent_wait_check(AgentWaitState *state){webkit_web_view_evaluate_javascript(state->view,state->script.c_str(),-1,nullptr,"vantage-agent://page.wait",nullptr,agent_wait_finished,state);}
