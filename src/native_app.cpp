...
TabState *new_tab(WindowState *state, const std::string &uri) {
    ...
    gtk_widget_set_size_request(hover_surface, -1, 20);
...
void install_style(GtkWidget *window) {
    ...
    gtk_css_provider_load_from_string(provider,
        ...
        ".tab-hover-surface { min-height: 20px; margin: 2px 9px 0; border-radius: 7px; background: transparent; }"
        ".browser-tab-body.inactive .tab-hover-surface:hover { background: #353432; }"
        ".browser-tab button { min-height: 18px; padding: 0 7px; border: 0; outline: none; background: transparent; box-shadow: none; color: #d8d4cc; }"
        ...
        ".new-tab { min-width: 28px; min-height: 16px; margin: 7px 3px 0; }"
        ...
        ".new-tab.flat { min-width: 28px; min-height: 16px; padding: 2px; border: 0; border-radius: 7px; background: transparent; color: #d8d4cc; box-shadow: none; }"
