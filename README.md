...
Version 0.1.11 is the current development version. It adds persistent normal-profile cookies
...
controls, opt-in Dark Reader-powered Dark Mode remembered per domain, persistent bookmarks, searchable history and downloads, private
...
Vantage v0.1.11 is the current development-line browser. The native GTK/WebKitGTK
