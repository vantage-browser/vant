...
Version 0.1.7 is the current release. It adds persistent normal-profile cookies
...
controls, optional Dark Reader-powered Dark Mode with per-domain exceptions, persistent bookmarks, searchable history and downloads, private
...
Vantage v0.1.7 is a released development-line browser. The native GTK/WebKitGTK
